...
urls = ["https://www.newegg.com/Product/ProductList.aspx?Submit=ENE&N=100167732%208000&IsNodeId=1&page={}".format(str(i)) for i in range(1, 6)]
...
with open('newegg_gamingLaptop.csv', 'w', encoding='utf-8') as csvfile:
